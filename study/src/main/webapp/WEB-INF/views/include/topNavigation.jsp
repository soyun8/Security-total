...
<div id="login_bar">
    <span id="login_bar_list">
        <a href="/help/noticeMain"><img style="margin-right: 30px" src="/img/callcenter.png" alt="고객센터"></a>
        <a href="" id="message" ><img style="margin-right: 30px" src="/img/message.png" alt="쪽지"></a> 
        <a href="/myPage/alarmList"><img style="margin-right: 30px" src="/img/bell.png" alt="알림"></a>
        
        <div class="profile_circle_box" onclick="logout_link_visibility()">
        	<img id="profile_img"src="/img/dog.jpg" alt="프로필사진"><!-- 나중에 프로필 사진 가져오기 -->
        </div>
    </span>
</div>
    ...
    <div class="logo_area">
        <a href="/sale/main">
            <div class="rabbit_logo">
                <img src="/img/rabbit_logo.png" alt="토끼마켓 로고">
            </div>
        </a>  
    </div>
